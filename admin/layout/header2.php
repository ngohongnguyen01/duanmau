                ...
                <ul class="nav nav2">
                    ...
                    <li class="nav-item">
                        <?php if (isset($_SESSION['admin'])) : ?>
                            <a href="" class="nav-link">
                                <img src="<?php echo BASE_URL.$_SESSION['admin']['hinh']?>" width="20px" height="20px" style="border-radius:20px;" alt="">
                                <?php echo "Admin" ?>
                            </a>
                        <?php endif; ?>
                    </li>
                    <li class="nav-item">
                        <?php if (isset($_SESSION['khachhang'])) : ?>
                            <a href="" class="nav-link">
                            <img src="<?php echo BASE_URL.$_SESSION['khachhang']['hinh']?>" width="20px" height="20px" style="border-radius:20px;" alt="">
